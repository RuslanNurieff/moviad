...
def train_patchcore(args: PatchCoreArgs, logger=None) -> None:
    ...
    # define the model
    patchcore = PatchCore(args.device, input_size=(224, 224), feature_extractor=feature_extractor)
...
def test_patchcore(args: PatchCoreTestArgs):
    print(f"Length test dataset: {len(args.test_dataset)}")
