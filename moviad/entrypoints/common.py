...
def load_datasets(dataset_config: DatasetConfig, dataset_type: DatasetType, dataset_category: str)\
    ...
    train_dataset = dataset_factory.build(dataset_type, Split.TRAIN, dataset_category, dataset_config.image_size)
    test_dataset = dataset_factory.build(dataset_type, Split.TEST, dataset_category, dataset_config.image_size)
